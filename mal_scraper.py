...
def search(title: str):
    # searches myanimelist for the first 3 most likely results and returns a list of processed info dictionaries
    search = mal.search('anime', title)['results'][:3] # get the first 5 entries that pop up
